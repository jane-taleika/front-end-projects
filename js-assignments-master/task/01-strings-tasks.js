...
function extractNameFromTemplate(value) {
  var arr=value.split("!").join("").split(" ").slice(-2);
return arr.join(" ");
}
...
function encodeToRot13(str) {
    var code=new Array(str.length).fill(0);
    for (var i=0; i<str.length; i++)
      code[i]=str.charCodeAt(i);
    var newStr=new Array(str.length).fill(0);
    for (var i=0; i<str.length; i++)
    {

      if (code[i]>64 && code[i]<78) code[i]+=13;
      else
      if (code[i]>77 && code[i]<91) code[i]-=13;
      else
      if (code[i]>96 && code[i]<110) code[i]+=13;
      else
      if (code[i]>109 && code[i]<123) code[i]-=13;
      else code[i]=code[i];

      newStr[i]=String.fromCharCode(code[i]);
    }
    return newStr.join("");
}
...
function getCardId(value) {
  var multi=value.charCodeAt(value.length-1);
  var mul=0;
  switch (multi){
    case 9827: mul=0;break;
    case 9830: mul=1;break;
    case 9829: mul=2;break;
    case 9824: mul=3;break;
  }
  ...
  var index=0;
    ...
    switch (code){
      ...
      case 49: index=9; break;
      case 74: index=10; break;
      case 81: index=11; break;
      case 75: index=12; break;
    }
